...
python main.py --approx_model_name models/Janus-Pro-1B --target_model_name models/Janus-Pro-7B -b
...
python main.py --approx_model_name models/Janus-Pro-1B --target_model_name models/Janus-Pro-7B --precision none
